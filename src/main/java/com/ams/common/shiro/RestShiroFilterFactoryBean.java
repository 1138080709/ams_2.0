...
/**
 * 继承 ShiroFilterFactoryBean 类,重写 createInstance 方法
 * 将 PathMatchingFilterChainResolver类 改为 我们重写的 RestPathMatchingFilterChainResolver类
 */
public class RestShiroFilterFactoryBean extends ShiroFilterFactoryBean {
    ...
    private static final class SpringShiroFilter extends AbstractShiroFilter {
        public SpringShiroFilter(WebSecurityManager webSecurityManager, FilterChainResolver resolver) {
            super();
